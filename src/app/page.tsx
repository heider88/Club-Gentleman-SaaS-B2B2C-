        ...
        <div className="flex flex-col items-center gap-6 border-b border-white/[0.08] pb-12 relative">
          ...
          <div className="flex flex-col items-center gap-4 w-full sm:w-auto mt-4">
            ...
            <div className="flex justify-center gap-3">
              ...
              {/* Botón de TikTok Fijo */}
              <a
                href="https://www.tiktok.com/@club.gentleman.ba?_r=1&_t=ZS-983XejWgLTN"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 flex items-center justify-center border border-white/5 border-t-white/10 bg-black/60 rounded-full hover:border-[#00f2fe]/50 transition-all text-white/60 hover:text-white hover:shadow-[0_0_20px_rgba(0,242,254,0.3)] group active:scale-95 overflow-hidden relative"
                title="TikTok"
              >
