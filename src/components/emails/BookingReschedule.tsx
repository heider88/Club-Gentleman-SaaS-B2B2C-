...
export const BookingReschedule = ({
    ...
    const previewText = `Tu cita ha sido reagendada. Nuevos detalles dentro.`;
            ...
            <Body style={main}>
                <Container style={container}>
                    ...
                    <Section style={contentSection}>
                        <Heading style={heading}>¡Tu cita ha sido Reagendada!</Heading>
                        <Text style={paragraph}>
                            Hola <strong style={{ color: "#ffffff" }}>{customerName}</strong>,
                        </Text>
                        <Text style={paragraph}>
                            Hemos actualizado los detalles de tu reserva. A continuación te presentamos tu nueva fecha y hora:
                        </Text>
                        ...
                        <Section style={card}>
                            ...
                            <Row style={cardRow}>
                                <Column style={{ width: "30%" }}>
                                    <Text style={cardLabel}>Nueva Hora:</Text>
                                </Column>
                                <Column>
                        ...
                        <Text style={paragraph}>
                            Te esperamos en nuestra sede física. Si tienes dudas o necesitas otro cambio, por favor contáctanos con anticipación.
                        </Text>
...
const headerSection = {
    ...
    borderBottom: "1px solid rgba(109, 50, 148, 0.4)", 
};
